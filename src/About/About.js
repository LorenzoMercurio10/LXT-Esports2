        ...
        <section id="about">
            <div className="about-background">
                <div className="col-xs-6 col-md-8 about-text">
                    ...
                    Il nuovo team metterà a disposizione del mercato i propri contenuti formativi e promuoverà iniziative di informazione e sensibilizzazione sui rischi connessi, come quelli del cyber bullismo, del match fixing, della ludopatia, della privacy e della non corretta alimentazione.</p>    
                </div>
            </div>
        </section>
